...
public class Butterflies : Fly
{
    public Butterflies(AbstractCreature abstractCreature, World world) : base(abstractCreature, world)
    {
        
    }

    public override void InitiateGraphicsModule() => graphicsModule ??= new ButterfliesGraphics(this);
